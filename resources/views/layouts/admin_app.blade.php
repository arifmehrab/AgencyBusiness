...
<head>
    ...
    <!-- summernotes CSS -->
    <link href="{{ asset('public/Backend/assets/vendor/summernote/dist/summernote-bs4.css') }}" rel="stylesheet" />
    <!-- Argon CSS -->
...
<body>
  ...
  <!-- Summernote Editor -->
 <script src="{{ asset('public/Backend/assets/vendor/summernote/dist/summernote-bs4.min.js') }}"></script>
  @stack('js')
   <!--- Toastr Message --->
    <script>
